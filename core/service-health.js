/* global module */
const DEFAULT_PORTS = { discovery: 49321, chat: 7890, pairing: 7891, sync: 7892, transfer: 49152 };
const RANGES = { discovery: 'udp', chat: 'tcp', pairing: 'tcp', sync: 'tcp', transfer: 'tcp' };
